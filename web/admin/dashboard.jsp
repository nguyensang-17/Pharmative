...
<head>
    ...
    <style>
        ...
        /* Logout button - cải tiến với xanh lá */
        .logout-btn {
            position: fixed;
            bottom: 28px;
            right: 28px;
            ...
            font-weight: 700;
            cursor: pointer;
            box-shadow: 0 8px 24px rgba(117,178,57,0.22);
        ...
        .logout-btn:hover {
            ...
            box-shadow: 0 10px 30px rgba(95,161,39,0.24);
            background: linear-gradient(135deg, var(--brand-green-dark), #4d8a1f);
        }
        .logout-btn i { font-size: 1rem; }

        /* Thêm phần Recent Activity */
        .recent-activity {
            background: var(--card-bg);
            border-radius: 16px;
            padding: 24px;
    ...
    <div class="dashboard-container">
        ...
        <div class="page-header">
            ...
            <p class="welcome-text">
                Xin chào, <strong>${sessionScope.currentUser != null ? sessionScope.currentUser.fullname : "Admin"}</strong>
                &nbsp;|&nbsp;
