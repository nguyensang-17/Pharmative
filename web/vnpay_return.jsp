                                ...
                                <body>
                                    ...
                                    <div class="site-wrap">
                                        <div class="payment-container">
                                            <% //=====1) Thu thập tham số trả về từ VNPAY=====Map<String, String> fields
                                                = new HashMap<>();
                                                        ...
                                                        String signRaw = Config.hashAllFields(new HashMap<>(fields));
                                                            ...
                                                            List<String> names = new ArrayList<>(fields.keySet());
                                                                    ...
                                                                    for (Iterator<String> it = names.iterator();
                                                                        ...
                                                                        sbEnc.append(k).append("=").append(URLEncoder.encode(v,
                                                                        ...
                                                                        String signEncoded =
                                                                        Config.hmacSHA512(Config.secretKey,
                                                                        sbEnc.toString());
                                                                        boolean isValid = (vnp_SecureHash != null)
                                                                        && (vnp_SecureHash.equalsIgnoreCase(signRaw) ||
                                                                        vnp_SecureHash.equalsIgnoreCase(signEncoded));
                                                                        ...
                                                                        String amount =
                                                                        request.getParameter("vnp_Amount"); // VND × 100
                                                                        String bankCode =
                                                                        ...
                                                                        boolean okCode = "00".equals(respCode) ||
                                                                        "00".equals(txnStatus);
                                                                        ...
                                                                        formattedAmount = String.format("%,d",
                                                                        amountValue / 100) + " VND";
                                                                        ...
                                                                        <div class="payment-card">
                                                                            ...
                                                                            <div class="payment-body">
                                                                                <% if (isValid && okCode) { %>
                                                                                    <div
                                                                                        class="payment-status status-success">
                                                                                        <div
                                                                                    ...
                                                                                    <% } else { %>
                                                                                        <div
                                                                                            class="payment-status status-fail">
                                                                                            <div
                                                                                                class="status-icon status-fail">
                                                                                                <i
                                                                                                    class="icon-close"></i>
                                                                                            </div>
                                                                                            <div>
                                                                                                ...
                                                                                                <div class="row mb-3">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <% if (isValid)
                                                                                                            { %>
                                                                                                            <span
                                                                                                                class="text-primary">HỢP
                                                                                                                LỆ</span>
                                                                                                            <% } else {
                                                                                                                %>
                                                                                                                <span
                                                                                                                    style="color: #b00020;">KHÔNG
                                                                                                                    HỢP
                                                                                                                    LỆ</span>
                                                                                                                <% }%>
                                                                                                    </div>
