            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <c:choose>
                    <c:when test="${param.subscribed == '1'}">
                        <div class="alert alert-success mt-3">Đăng ký thành công! Vui lòng kiểm tra email.</div>
                    </c:when>
                    <c:when test="${param.subscribed == '0'}">
                        <div class="alert alert-danger mt-3">Đăng ký thất bại. Vui lòng thử lại.</div>
                    </c:when>
                </c:choose>
